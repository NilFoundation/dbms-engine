...
// call event_listener::OnFlushCompleted().
//
...
// in a complex way.
        ...
        public:
            ...
            virtual void OnFlushCompleted(database * /*db*/, const FlushJobInfo & /*flush_job_info*/) {
            }
            ...
            // it should not run for an extended period of time before the function
            // returns.  Otherwise, RocksDB may be blocked.
            virtual void OnFlushBegin(database * /*db*/, const FlushJobInfo & /*flush_job_info*/) {
            }
            ...
            // it should not run for an extended period of time before the function
            // returns.  Otherwise, RocksDB may be blocked.
            virtual void OnCompactionBegin(database * /*db*/, const compaction_job_info & /*ci*/) {
            }
            ...
            virtual void OnCompactionCompleted(database * /*db*/, const compaction_job_info & /*ci*/) {
            }
            ...
            virtual void OnExternalFileIngested(database * /*db*/, const ExternalFileIngestionInfo & /*info*/) {
            }
