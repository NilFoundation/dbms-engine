...
// read from disk.
        environment_type *NewEncryptedEnv(environment_type *base_env, EncryptionProvider *provider);
...
// E.g. CTR (Counter operation mode) supports this requirement.
        ...
        protected:
            ...
            virtual status_type EncryptBlock(uint64_t blockIndex, char *data, char *scratch) = 0;

            // Decrypt a block of data at the given block index.
            // Length of data is equal to BlockSize();
            virtual status_type DecryptBlock(uint64_t blockIndex, char *data, char *scratch) = 0;
        };
...
// it is considered suitable for use.
        ...
        public:
            CTRCipherStream(BlockCipher &c, const char *iv, uint64_t initialCounter) : cipher_(c),
                    iv_(iv, c.BlockSize()), initialCounter_(initialCounter) {
            };
        ...
        protected:
            ...
            // Encrypt a block of data at the given block index.
            // Length of data is equal to BlockSize();
            virtual status_type EncryptBlock(uint64_t blockIndex, char *data, char *scratch) override;

            // Decrypt a block of data at the given block index.
            // Length of data is equal to BlockSize();
            virtual status_type DecryptBlock(uint64_t blockIndex, char *data, char *scratch) override;
        };
...
// actions.
        ...
        public:
            ...
            // for a new file.
            virtual status_type CreateNewPrefix(const std::string &fname, char *prefix, size_t prefixLength) = 0;

            // CreateCipherStream creates a block access cipher stream for a file given
            // given name and options.
            virtual status_type CreateCipherStream(const std::string &fname, const environment_options &options,
...
// it is considered suitable for use, provided a safe BlockCipher is used.
        ...
        public:
            ...
            // CreateNewPrefix initialized an allocated block of prefix memory
            // for a new file.
            virtual status_type CreateNewPrefix(const std::string &fname, char *prefix, size_t prefixLength) override;
        ...
        protected:
            ...
            virtual status_type CreateCipherStreamFromPrefix(const std::string &fname,
