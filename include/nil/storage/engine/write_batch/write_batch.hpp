...
namespace nil {
    namespace engine {
        ...
        public:
            ...
            virtual status_type insert(column_family_handle *column_family, const engine::slice &key, const engine::slice &value) = 0;

            virtual status_type insert(const engine::slice &key, const engine::slice &value) = 0;
            ...
            virtual status_type insert(column_family_handle *column_family, const slice_parts &key,
                ...
                engine::slice key_slice(key, &key_buf);
                engine::slice value_slice(value, &value_buf);
            ...
            virtual status_type merge(column_family_handle *column_family, const engine::slice &key, const engine::slice &value) = 0;

            virtual status_type merge(const engine::slice &key, const engine::slice &value) = 0;
            ...
            virtual status_type remove(column_family_handle *column_family, const engine::slice &key) = 0;

            virtual status_type remove(const engine::slice &key) = 0;
            ...
            virtual status_type single_remove(column_family_handle *column_family, const engine::slice &key) = 0;

            virtual status_type single_remove(const engine::slice &key) = 0;
            ...
            virtual status_type remove_range(column_family_handle *column_family, const engine::slice &begin_key,
                                             const engine::slice &end_key) = 0;

            virtual status_type remove_range(const engine::slice &begin_key, const engine::slice &end_key) = 0;
            ...
            virtual status_type remove_range(column_family_handle *column_family, const slice_parts &begin_key,
                ...
                engine::slice begin_key_slice(begin_key, &begin_key_buf);
                engine::slice end_key_slice(end_key, &end_key_buf);
            ...
            // replication.
            virtual status_type put_log_data(const engine::slice &blob) = 0;
