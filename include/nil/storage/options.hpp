...
// compression method (if any) is used to compress a block.
        ...
        struct DBOptions {
            ...
            // Default: environment_type::Default()
            environment_type *env = environment_type::Default();
            ...
            // environment_type::SetBackgroundThreads
            //
            // Default: -1
            //
            // Dynamically changeable through SetDBOptions() API.
...
// Options that control write operations
        struct WriteOptions {
            ...
            WriteOptions() : sync(false), disableWAL(false), ignore_missing_column_families(false), no_slowdown(false),
                    low_pri(false) {
            }
        };
...
// CompactRangeOptions is used by CompactRange() call.
        struct CompactRangeOptions {
            ...
            BottommostLevelCompaction bottommost_level_compaction = BottommostLevelCompaction::kIfHaveCompactionFilter;
