 ...
 */
        ...
        extern const slice_transform *NewFixedPrefixTransform(size_t prefix_len);

        extern const slice_transform *NewCappedPrefixTransform(size_t cap_len);

        extern const slice_transform *NewNoopTransform();
